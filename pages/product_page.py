...
class ProductPage(BasePage):
    ...
    def should_be_product_name(self):
        assert self.is_element_present(*self.locators.PRODUCT_NAME), \
            "Product name not found."

    def should_be_product_price(self):
        assert self.is_element_present(*self.locators.PRODUCT_PRICE), \
    ...
    def should_be_cart_total_message(self):
        assert self.is_element_present(*self.locators.PRICE_MESSAGE), \
    ...
    def should_be_correct_product_in_success_message(self):
        msg_product_name = self.browser.find_element(
            *self.locators.SUCCESS_MESSAGE_PRODUCT_NAME
        ).text
        product_name = self.browser.find_element(
            *self.locators.PRODUCT_NAME
        ).text
    ...
    def should_match_cart_total_msg_to_product_price(self):
        message_cart_price = self.browser.find_element(
            *self.locators.CART_MESSAGE_PRICE
        ).text
        product_price = self.browser.find_element(
            *self.locators.PRODUCT_PRICE
        ).text
